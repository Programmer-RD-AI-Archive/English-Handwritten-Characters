...
class DataSet:
    ...
    def data_to_X_train_y_train_X_test_y_test(self, data):
        ...
        torch.save(y_train,self.save_dir + "X_train.pt")
        torch.save(y_train,self.save_dir + "X_train.pth")
        torch.save(y_test,self.save_dir + "X_test.pt")
        torch.save(y_test,self.save_dir + "X_test.pth")
