...
class DataSet:
    def __init__(self, data_dir: str = "./raw/", save_dir: str = "./data/") -> None:
        self.data_csv = pd.read_csv(data_dir + "english.csv")
        self.data_dir = data_dir
        self.save_dir = save_dir

    def analytics(self, plot: bool = False) -> tuple:
    ...
    def data_to_X_train_y_train_X_test_y_test(self, data: list) -> tuple:
        print("Converting Data to X,y train,test")
        X = []
        y = []
