...
class PreProccessing:
    def __init__(self,to_tensor:bool,random_vertical_flip:bool,color_jitter:bool,random_grayscale:bool,random_horizontal_flip:bool=True,random_rotation:bool=True) -> None:
